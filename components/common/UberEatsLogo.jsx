...
export default function UberEatsLogo({ eatsColor, uberColor, ...props }) {
  return (
    <svg
...
UberEatsLogo.propTypes = {
  eatsColor: PropTypes.string,
  uberColor: PropTypes.string
}

UberEatsLogo.defaultProps = {
  eatsColor: '#5fb709',
  uberColor: '#262626'
}
